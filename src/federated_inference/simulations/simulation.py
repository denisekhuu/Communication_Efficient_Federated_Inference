...
class Simulation():
    ...
    def transform_data(self, dataset: TorchDataset, data_distribution_type: DataDistributionType | None = None, data_mode: DataMode | None = None, transform_type: TransformType | None = None, transform_config = None): 
        transformation = None
